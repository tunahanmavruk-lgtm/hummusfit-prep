...
function calculateBatches(meals, inventory, sales, salesWindowDays = 7, dayName = null) {
  ...
  const HOLIDAY_TARGET_DAYS_MAP = {
    ...
    '2026-7-13': { mon: 4.5, tue: 4.5, wed: 4.5, thu: 4.5, fri: 4.5, sat: 4.5, cap: 22000 },
    '2026-7-14': { mon: 4.5, tue: 4.5, wed: 4.5, thu: 4.5, fri: 4.5, sat: 4.5, cap: 22000 },
    '2026-7-15': { mon: 4.5, tue: 4.5, wed: 4.5, thu: 4.5, fri: 4.5, sat: 4.5, cap: 22000 },
  };
