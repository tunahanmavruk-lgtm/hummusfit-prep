...
function calculateBatches(meals, inventory, sales, salesWindowDays = 7, dayName = null) {
  ...
  const HOLIDAY_TARGET_DAYS_MAP = {
    ...
    '2026-7-13': { mon: 3.5, tue: 3.5, wed: 3.5, thu: 3.5, fri: 3.5, sat: 3.5, cap: 18000 },
    '2026-7-14': { mon: 3.5, tue: 3.5, wed: 3.5, thu: 3.5, fri: 3.5, sat: 3.5, cap: 18000 },
    '2026-7-15': { mon: 3.5, tue: 3.5, wed: 3.5, thu: 3.5, fri: 3.5, sat: 3.5, cap: 18000 },
  };
