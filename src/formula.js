...
const LAUNCH_OVERRIDES = {
  ...
  "The Golden Arches Wrap":            { minBatches: 3, from: "2026-07-11", until: "2026-07-31" },
...
function calculateBatches(meals, inventory, sales, salesWindowDays = 7, dayName = null) {
  ...
  const HOLIDAY_TARGET_DAYS_MAP = {
    ...
    '2026-7-13': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.5, fri: 3.0, sat: 2.5, cap: 20000 },
    '2026-7-14': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.5, fri: 3.0, sat: 2.5, cap: 20000 },
    '2026-7-15': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.5, fri: 3.0, sat: 2.5, cap: 20000 },
  };
