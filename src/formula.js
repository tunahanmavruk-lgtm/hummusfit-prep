...
const LAUNCH_OVERRIDES = {
  ...
  "Philly Cheesesteak Quesadilla": { minBatches: 8, maxBatches: 8, from: "2026-07-19", until: "2099-12-31" },
  ...
  "Texas Queso Steak Bowl":        { minBatches: 5,  from: "2026-07-20", until: "2026-07-23" },
  ...
  // Friday Jul 25 G1 — TARGET=4.0 days, verified zero expiry risk
  "Chipotle Chicken (1lb Competition Approved)":           { minBatches: 17, maxBatches: 17, from: "2026-07-24", until: "2026-07-25" },
  "Competition Approved Grilled Chicken (1lb)":            { minBatches: 12, maxBatches: 12, from: "2026-07-24", until: "2026-07-25" },
  "Cheeseburger Bowl":                                     { minBatches: 8,  maxBatches: 8,  from: "2026-07-24", until: "2026-07-25" },
  "Meatball Parmesan Wrap":                                { minBatches: 7,  maxBatches: 7,  from: "2026-07-24", until: "2026-07-25" },
  "BBQ Chicken Garlic Parm Potatoes":                      { minBatches: 6,  maxBatches: 6,  from: "2026-07-24", until: "2026-07-25" },
  "Broritto Burrito":                                      { minBatches: 6,  maxBatches: 6,  from: "2026-07-24", until: "2026-07-25" },
  "Competition Approved Oven Baked Cod (1lb)":             { minBatches: 6,  maxBatches: 6,  from: "2026-07-24", until: "2026-07-25" },
  "Arnold 2022 Bowl":                                      { minBatches: 4,  maxBatches: 4,  from: "2026-07-24", until: "2026-07-25" },
  "Baja Chicken Tacos":                                    { minBatches: 4,  maxBatches: 4,  from: "2026-07-24", until: "2026-07-25" },
  "Competition Approved Sticky Rice (1lb)":                { minBatches: 4,  maxBatches: 4,  from: "2026-07-24", until: "2026-07-25" },
  "Stacked and Jacked":                                    { minBatches: 4,  maxBatches: 4,  from: "2026-07-24", until: "2026-07-25" },
  "Taco Build Quesadilla":                                 { minBatches: 4,  maxBatches: 4,  from: "2026-07-24", until: "2026-07-25" },
  "Baked Herbed Tilapia (1lb Competition Approved)":       { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Brookfield Chicken Bowl":                               { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Buffalo Crispy Chicken Wrap":                           { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Chicken Mushroom Pot Stickers":                         { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Fit Ala Vodka With Chicken":                            { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Spicy Buffalo Wrap":                                    { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Strongsville Chicken Ranch Fold":                       { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Thai Chili Chicken":                                    { minBatches: 3,  maxBatches: 3,  from: "2026-07-24", until: "2026-07-25" },
  "Cinnamon Roll Pancakes":                                { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Club Wrap":                                             { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Farfalle & Chicken Alfredo":                            { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Fit-Fil-A":                                             { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Grilled Chicken Parmesan Wrap":                         { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Grilled Chicken Pesto Wrap":                            { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Hey Arnold! Burrito":                                   { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Nacho Average Vegan Bowl":                              { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Southwest Chicken Bowl":                                { minBatches: 2,  maxBatches: 2,  from: "2026-07-24", until: "2026-07-25" },
  "Blueberry French Toast":                                { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "Crispy Vegan Wrap":                                     { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "Gluten Free Carbonara Chicken":                         { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "Nacho Average Bowl":                                    { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "Soho Steak Bowl":                                       { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "Strawberry Protein French Toast":                       { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "TexMex Potato Hash":                                    { minBatches: 1,  maxBatches: 1,  from: "2026-07-24", until: "2026-07-25" },
  "GLORIOUS GAINS Steak Bites & Cilantro Lime Rice":       { minBatches: 0,  maxBatches: 0,  from: "2026-07-24", until: "2026-07-25" },
  "Buffalo Chicken Meatballs":                             { minBatches: 0,  maxBatches: 0,  from: "2026-07-24", until: "2026-07-25" },
  ...
  // Thu Jul 29 — force correct batches, formula using distorted rates
  "Crispy Baked Chicken Wrap":                     { minBatches: 6,  from: "2026-07-29", until: "2026-07-30" },
  "Zeus Bowl":                                     { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  "Buffalo Chicken Quesadilla":                    { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  "Closed on Sunday Crispy Chicken Bowl":          { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  "Rigatoni & Meatballs":                          { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "Herb Butter Steak Tips Bowl":                   { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "Lo Mein Teriyaki Steak":                        { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "HFit Signature Fold":                           { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "Teriyaki Flank Bowl":                           { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "MsWendy Buff Nuggets":                          { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "Chicken Taco Bowl":                             { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "BBQ Chicken Mac Bowl":                          { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "Zeus Bowl V2":                                  { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Breakfast Burrito":                             { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Buffalo Mac N Chicken":                         { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Chicken Stir Fry":                              { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Keto Ricotta Meatballs":                        { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Pineapple Teriyaki Meatballs":                  { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "The Clean Bulk Pasta Bowl":                     { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Low Carb Keto Cheeseburger Bowl":               { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "BBQ Meltdown":                                  { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Competition Approved Grilled Flank Steak (1lb)": { minBatches: 3, from: "2026-07-29", until: "2026-07-30" },
  "Rigatoni & Meatballs":                          { minBatches: 4,  from: "2026-07-29", until: "2026-07-30" },
  "6-Guys Patty Melt":                             { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  "Texas Queso Steak Bowl":                        { minBatches: 3,  from: "2026-07-29", until: "2026-07-30" },
  // Thu Jul 29 — force correct batches while rolling avg builds history
  "Crispy Baked Chicken Wrap":                     { minBatches: 6,  from: "2026-07-29", until: "2026-07-30" },
  "Zeus Bowl":                                     { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  "Buffalo Chicken Quesadilla":                    { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  "Closed on Sunday Crispy Chicken Bowl":          { minBatches: 5,  from: "2026-07-29", until: "2026-07-30" },
  ...
  "BBQ Meltdown":                                  { minBatches: 0, maxBatches: 0, from: "2026-07-31", until: "2026-08-02" },
  "BBQ Chicken Mac Bowl":                          { minBatches: 0, maxBatches: 0, from: "2026-07-31", until: "2026-08-02" },
  "Closed on Sunday Crispy Chicken Bowl":          { minBatches: 0, maxBatches: 8, from: "2026-07-31", until: "2026-08-02" },
...
function calculateBatches(meals, inventory, sales, salesWindowDays = 7, dayName = null, directToAssemblyParam = [], rollingRates = {}) {
  ...
  const prepSheet = meals.map(meal => {
    ...
    const TARGET_DAYS = holidayOverride !== null ? holidayOverride
      ...
      : isFriday && executionDate.getMonth() === 8 && executionDate.getDate() === 4 ? 6.5   // Labor Day: cron runs Thu Sep 4, generates Fri Sep 5 (no Mon Sep 7 cook → covers Sat PM→Thu PM)
    ...
    const MAX_SHELF_DAYS      = isSaturday ? 4 : 4;
