...
const LAUNCH_OVERRIDES = {
  ...
  // Precise min/max to prevent both overcooking AND undercooking
  // Based on 3.5 day target with actual inventory Jul 19
  "BBQ Chicken Garlic Parm Potatoes":  { minBatches: 11, maxBatches: 11, from: "2026-07-20", until: "2026-07-21" },
  "Broritto Burrito":                  { minBatches: 7,  maxBatches: 8,  from: "2026-07-20", until: "2026-07-21" },
  "Baja Chicken Tacos":                { minBatches: 8,  maxBatches: 9,  from: "2026-07-20", until: "2026-07-21" },
  "Buffalo Crispy Chicken Wrap":       { minBatches: 4,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "Brookfield Chicken Bowl":           { minBatches: 6,  maxBatches: 7,  from: "2026-07-20", until: "2026-07-21" },
  "Southwest Chicken Quesadilla":      { minBatches: 6,  maxBatches: 7,  from: "2026-07-20", until: "2026-07-21" },
  "Farfalle & Chicken Alfredo":        { minBatches: 5,  maxBatches: 6,  from: "2026-07-20", until: "2026-07-21" },
  "Fit Ala Vodka With Chicken":        { minBatches: 5,  maxBatches: 6,  from: "2026-07-20", until: "2026-07-21" },
  "Thai Chili Chicken":                { minBatches: 6,  maxBatches: 7,  from: "2026-07-20", until: "2026-07-21" },
  "Soho Steak Bowl":                   { minBatches: 4,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "TexMex Potato Hash":                { minBatches: 5,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "Hot Honey Steak & Mac":             { minBatches: 5,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "Grilled Chicken Pesto Wrap":        { minBatches: 3,  maxBatches: 4,  from: "2026-07-20", until: "2026-07-21" },
  "Gluten Free Carbonara Chicken":     { minBatches: 4,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "Southwest Chicken Bowl":            { minBatches: 4,  maxBatches: 5,  from: "2026-07-20", until: "2026-07-21" },
  "Nacho Average Bowl":                { minBatches: 3,  maxBatches: 3,  from: "2026-07-20", until: "2026-07-21" },
  // Cap well-stocked meals that formula is over-cooking
  "Taco Build Quesadilla":             { minBatches: 0,  maxBatches: 0,  from: "2026-07-20", until: "2026-07-21" },
  "Cheeseburger Bowl":                 { minBatches: 0,  maxBatches: 0,  from: "2026-07-20", until: "2026-07-21" },
  "Spicy Buffalo Wrap":                { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Meatball Parmesan Wrap":            { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Club Wrap":                         { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "GLORIOUS GAINS":                    { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Fit-Fil-A":                         { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Stacked and Jacked":                { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Chicken Mushroom Pot Stickers":     { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  "Grilled Chicken Parmesan Wrap":     { minBatches: 0,  maxBatches: 2,  from: "2026-07-20", until: "2026-07-21" },
  // Monday Jul 21 G1 — depleted meals need minBatches only (no maxBatches cap)
  "Broritto Burrito":                  { minBatches: 10, from: "2026-07-21", until: "2026-07-20" },
  "BBQ Chicken Garlic Parm Potatoes":  { minBatches: 10, from: "2026-07-21", until: "2026-07-20" },
  "Buffalo Crispy Chicken Wrap":       { minBatches: 7,  from: "2026-07-21", until: "2026-07-20" },
  "Baja Chicken Tacos":                { minBatches: 8,  from: "2026-07-21", until: "2026-07-20" },
  "Brookfield Chicken Bowl":           { minBatches: 6,  from: "2026-07-21", until: "2026-07-20" },
  "Southwest Chicken Quesadilla":      { minBatches: 6,  from: "2026-07-21", until: "2026-07-20" },
  "Farfalle & Chicken Alfredo":        { minBatches: 5,  from: "2026-07-21", until: "2026-07-20" },
  "Fit Ala Vodka With Chicken":        { minBatches: 5,  from: "2026-07-21", until: "2026-07-20" },
  "Thai Chili Chicken":                { minBatches: 5,  from: "2026-07-21", until: "2026-07-20" },
  "Soho Steak Bowl":                   { minBatches: 5,  from: "2026-07-21", until: "2026-07-20" },
  "TexMex Potato Hash":                { minBatches: 4,  from: "2026-07-21", until: "2026-07-20" },
  "Hot Honey Steak & Mac":             { minBatches: 4,  from: "2026-07-21", until: "2026-07-20" },
  "Grilled Chicken Pesto Wrap":        { minBatches: 4,  from: "2026-07-21", until: "2026-07-20" },
  "Gluten Free Carbonara Chicken":     { minBatches: 4,  from: "2026-07-21", until: "2026-07-20" },
  "Nacho Average Bowl":                { minBatches: 3,  from: "2026-07-21", until: "2026-07-20" },
  "Vegan Cheeseburger Bowl":           { minBatches: 2,  from: "2026-07-21", until: "2026-07-20" },
  // Tuesday Jul 22 G2
