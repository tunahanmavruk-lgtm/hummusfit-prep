...
function calculateBatches(meals, inventory, sales, salesWindowDays = 7, dayName = null) {
  ...
  const HOLIDAY_TARGET_DAYS_MAP = {
    ...
    '2026-7-16': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.0, fri: 3.0, sat: 3.0, cap: 22000 },
    '2026-7-17': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.0, fri: 3.0, sat: 3.0, cap: 22000 },
    '2026-7-18': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.0, fri: 3.0, sat: 3.0, cap: 22000 },
    '2026-7-19': { mon: 3.0, tue: 3.0, wed: 3.0, thu: 3.0, fri: 3.0, sat: 3.0, cap: 22000 },
  };
