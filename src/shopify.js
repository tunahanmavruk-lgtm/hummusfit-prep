...
const CARRY_CONFIG = {
  ...
  Wednesday: ['Tuesday','Wednesday','Thursday'],            // Until Thu cook lands Fri PM — cover Fri AM gap
  Thursday:  ['Monday','Tuesday','Wednesday'],             // Use midweek only — Thu/Fri/Sat/Sun distorted by weekend
